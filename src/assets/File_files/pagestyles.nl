...
.unrollformtabheaderexpand	{ padding: 5px; background: #24385B url(/images/forms/border/unrolltab_header_expand.png) repeat-x; }
...
.subtabcornerul			{ width: 4px; height: 4px; font-size: 0px; background: #DEE1E7 url(/images/core/common/corner_r4_t_w.png) 0px 0px; }
.subtabcornerur			{ width: 4px; height: 4px; font-size: 0px; background: #DEE1E7 url(/images/core/common/corner_r4_t_w.png) -4px 0px; }
.subtabcornerll			{ width: 4px; height: 4px; font-size: 0px; background: #DEE1E7 url(/images/core/common/corner_r4_t_w.png) 0px 4px; }
.subtabcornerlr			{ width: 4px; height: 4px; font-size: 0px; background: #DEE1E7 url(/images/core/common/corner_r4_t_w.png) 4px 4px; }
...
.unrollformsubtabheaderexpand		{ padding: 5px; background: #24385B url(/images/forms/border/unrollsubtab_header_expand.png) repeat-x; }
...
.listcornerul			{ width: 4px; height: 4px; font-size: 0px; background: #DEE1E7 url(/images/core/common/corner_r3_t_gray_w.png) 0px 0px; }
.listcornerur			{ width: 4px; height: 4px; font-size: 0px; background: #DEE1E7 url(/images/core/common/corner_r3_t_gray_w.png) -3px 0px; }
.listcornerll			{ width: 4px; height: 4px; font-size: 0px; background: #DEE1E7 url(/images/core/common/corner_r3_t_gray_w.png) 0px 3px; }
.listcornerlr			{ width: 4px; height: 4px; font-size: 0px; background: #DEE1E7 url(/images/core/common/corner_r3_t_gray_w.png) 3px 3px; }
...
.ns-menuheader > a,
#ns_navigation .ns-menuheader > a{
	color: rgba(36,56,91,0.40) !important;
	border-top: 1px solid rgba(36,56,91,0.10);
}
...
ul#uir-global-search-container > li.ns-active
{
    background: #E0E6EF;
}
...
@media screen {
    ...
    .ns-dashboard-column .ns-portlet-wrapper[data-portlet-type='calendar'] .ns-monthly-view .ns-today,
    .ns-portlet-wrapper[data-portlet-type='calendar'] .ns-monthly-view .ns-today .ns-event-view .ns-event-content,
    .ns-portlet-wrapper[data-portlet-type='calendar'] .ns-weekly-view .ns-day-info.ns-today,
    .ns-calendar-picker-popup .ns-picker-table .ns-picker-significant-day.ns-today
    {
        background-color: #E0E6EF !important;
    }

    .ns-portlet-wrapper[data-portlet-type="calendar"] .ns-monthly-view .ns-today .ns-busy-indicators-container .ns-busy-indicator {
        background-color: #24385B;
    }
    ...
    .ns-portlet-icon-overflow:hover {
        background-color: #24385B !important;
    }
    ...
    .ns-portlet-wrapper div .ns-portlet-controls {
        background-color: #607799 !important;  /* This is here because of the IE9. For other browsers it will be replace by next line*/
        background: linear-gradient(to right, rgba(96,119,153,0.00), rgba(96,119,153,1.00) 20%) !important;
    }
    ...
    .ns-chart-portlet-iconrow .ns-portlet-icon-selected
    {
        /* icon arrow has only this color in png */
        background-color: #5B718C;
    }

    .ns-portlet-wrapper .ns-portlet-control-panel {
        background-color: #E0E6EF;
    }

    .ns-portlet-wrapper[data-portlet-type='calendar'] .ns-calendar-view-switch li:hover {
        background-color: #E0E6EF;
        color: #607799;
    }

    .ns-portlet-wrapper[data-portlet-type='calendar'] .ns-calendar-view-switch li {
        color: #607799;
    }

    .ns-portlet-wrapper[data-portlet-type='calendar'] .ns-calendar-view-switch {
        border-color: #607799 !important;
    }

    .ns-portlet-wrapper[data-portlet-type='calendar'] .ns-calendar-view-switch .ns-selected {
...
.portletFilterBar	{ background-color: #E0E6EF; }
